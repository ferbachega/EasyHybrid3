...
class NormalModesAnalysisWindow(Gtk.Window):
    ...
    def OpenWindow (self):
        ...
        if self.visible  ==  False:
            ...
            self.builder.add_from_file(os.path.join(self.home,'gui/windows/normal_modes_analysis.glade')) #/home/fernando/programs/EasyHybrid3/gui/windows/normal_mode_analysis.glade
