...
class SelectionListWindow(Gtk.Window):
    ...
    def OpenWindow (self):
        ...
        if self.visible  ==  False:
            ...
            self.builder.add_from_file(os.path.join(self.home,'gui/windows/selection_list.glade'))
            ...
            self.system_names_combo.set_model(self.main_session.system_liststore)
            ...
            self.system_names_combo.set_active_iter(system.e_liststore_iter)
    ...
    def on_system_names_combobox_changed(self, widget):
        ...
        if index == -1:
            ...
            _, system_id = self.main_session.system_liststore[index]
    ...
    def on_treeview_Objects_row_activated(self, tree, event, data):
        ...
        _, vobj_id, e_id = self.main_session.vobject_liststore_dict[e_id][coords_cb_index]
