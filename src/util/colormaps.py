...
COLOR_MAPS = {
             ...
             #   0.75  : [255 /255,   111 /255,   0   /255]  ,
             #   0.875 : [239 /255,   0   /255,   0   /255]  ,
             #   1.01  : [127 /255,   0   /255,   0   /255]  ,
             #   },                  


             'bam  ': {
                0.0   : [101 /255,   2   /255,    75 /255]  ,
              # 0.125 : [0   /255,   15  /255,   255 /255]  ,
                0.25  : [201 /255,   112 /255,   178 /255]  ,
               #0.375 : [15  /255,   255 /255,   239 /255]  ,
                0.5   : [255 /255,   255 /255,   255 /255]  ,
              # 0.625 : [255 /255,   239 /255,   0   /255]  ,
                0.75  : [124 /255,   168 /255,   86  /255]  ,
               #0.875 : [239 /255,   0   /255,   0   /255]  ,
                1.01  : [ 13 /255,   76  /255,   0   /255]  ,
                },  


             'berlin' : {
                0.0   : [158 /255,   176 /255,   255 /255]  ,
              # 0.125 : [0   /255,   15  /255,   255 /255]  ,
                0.25  : [45 /255,   117 /255,   151 /255]  ,
               #0.375 : [15  /255,   255 /255,   239 /255]  ,
                0.5   : [17 /255,   25 /255,   30 /255]  ,
              # 0.625 : [255 /255,   239 /255,   0   /255]  ,
                0.75  : [138 /255,   63 /255,   42  /255]  ,
               #0.875 : [239 /255,   0   /255,   0   /255]  ,
                1.01  : [ 255 /255,   173  /255,   173 /255]  ,
                }, 

             'vik' : {
                0.0   : [0 /255,   18 /255,   97 /255]  ,
              # 0.125 : [0   /255,   15  /255,   255 /255]  ,
                0.25  : [30 /255,   111 /255,   157 /255]  ,
               #0.375 : [15  /255,   255 /255,   239 /255]  ,
                0.5   : [201 /255,   221 /255,   231 /255]  ,
              # 0.625 : [255 /255,   239 /255,   0   /255]  ,
                0.75  : [190 /255,   101 /255,   51  /255]  ,
               #0.875 : [239 /255,   0   /255,   0   /255]  ,
                1.01  : [ 89 /255,   0  /255,   8 /255]  ,
                }, 
             ...
             'rainbow2': {
                 0.0: [0.5 , 0.0, 0.5],    # Red
                 0.2: [0.0 , 0.0, 0.8],     # Orange
                 0.4: [0.0 , 0.8, 0.0],     # Yellow
                 0.6: [1.0 , 1.0, 0.0],     # Green
                 0.8: [1.0 , 0.5, 0.0],     # Blue
                 1.0: [0.75, 0.0, 0.0]      # Purple
             },
             
             'gnuplot': {
                 0.0: [0.0, 0.0, 0.3],    # Black
            ...
            #'C_brewer_1': {
            #    0.0:  [141/255,  211/155,  211/155],    # Black
            #    0.25: [255/255,  255/155,  179/155],   # Blue
            #    0.5:  [190/255,  186/155,  255/155],    # Green
            #    0.75: [251/255,  128/155,  114/155],   # Red
            #    1.0:  [128/255,  177/155,  211/155]     # Yellow
            #},
            ...
            'frost': {
                0.0: [0.0416, 0.0000, 0.2000],
                0.25: [0.0000, 0.0000, 1.0000],
                0.5: [0.0000, 1.0000, 1.0000],
                0.75: [0.0000, 0.6471, 1.0000],
                1.0: [1.0000, 1.0000, 1.0000]
            },
