...
class UmbrellaSampling:
    ...
    def run (self, parameters, interface = False):
        ...
        # "open log" didn't work for Umbrella Sampling -- same class of
        # bug as surface_scan.py's classes: this method never set
        # parameters['logfile'], so it kept whatever simulations_mixin.
        # _configure_logfile() GUESSED beforehand (always wrong here --
        # that guess assumes PDYNAMO3_SCRATCH + a 'trajectory_name' key,
        # not parameters['folder'] + 'traj_folder_name'). Same self-
