...
class AlignTrajectoryWindow:
    ...
    def OpenWindow (self, vobject = None):
        ...
        if self.Visible  ==  False:
            ...
            self.builder.add_from_file(os.path.join(self.main.home,'src/gui/windows/analysis/align_trajectory.glade'))
            self.builder.connect_signals(self)
            
            self.window = self.builder.get_object('window')
            self.window.set_title('Align Trajectory')
            ...
            self.builder.get_object('chkbox_reference').hide()
